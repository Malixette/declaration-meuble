 ...
 */
class Version20180615135156 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mairie ADD CONSTRAINT FK_3946A254A73F0036 FOREIGN KEY (ville_id) REFERENCES villes (id)');
        $this->addSql('ALTER TABLE hebergement ADD CONSTRAINT FK_4852DD9C286C17BC FOREIGN KEY (villes_id) REFERENCES villes (id)');
    }
